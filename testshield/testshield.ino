...
//Question 1 - what is 100%
//Max current for the diods?
//Time to send data to 3 chips?
//What is max current the board can give?
...
int bPos = 0;
int ticks = 0;
//Setting up the 100% on constants
//each channel can be set from 0 to 2**12-1 (4095)
//To make sure not to kill the LEDs lets set 100% to 500 (approx 10%  of max)
int led100 = 500;
int r100 = led100;
int g100 = led100;
int b100 = led100;
